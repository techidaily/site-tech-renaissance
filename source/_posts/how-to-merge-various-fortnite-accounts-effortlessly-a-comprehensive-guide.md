---
title: How to Merge Various Fortnite Accounts Effortlessly – A Comprehensive Guide
date: 2024-08-05T02:11:30.856Z
updated: 2024-08-06T02:11:30.856Z
categories:
  - BestProducts
description: This Article Describes How to Merge Various Fortnite Accounts Effortlessly – A Comprehensive Guide
excerpt: This Article Describes How to Merge Various Fortnite Accounts Effortlessly – A Comprehensive Guide
...
## How to Merge Various Fortnite Accounts Effortlessly – A Comprehensive Guide

Close 

 This feature is no longer offered by Fortnite. This article remains for archival purposes only.

 Epic Games released an account merging feature for its hugely popular battle royale title Fortnite in November 2018\. If a person has more than one account on multiple platforms across Xbox One, PlayStation 4, PC, etc, this lets players combine them, transferring cosmetic items, V-Bucks, Save the World campaign access, and more.

 If you want to know how to merge Fortnite accounts, keep reading and we'll show you how.
...
* One account needs to be played on Xbox One or Switch and the other on PS4 before Sept. 28, 2018 to be eligible.
...
##  What Does or Doesn't Transfer After a Fortnite Account Merge? 
 ...
 Other items, like Support-A-Creator status, Unreal Marketplace items, Creative Islands, and Save the World account level and progress won't carry over from your Secondary Account.
...
[ How to Unlink Your Epic Games Account ](https://www.lifewire.com/how-to-unlink-epic-games-account-4707757) 

 FAQ

* How do I delete my Fortnite account?  
 To delete your Fortnite account,[ delete your Epic Games account](https://www.lifewire.com/how-to-delete-epic-games-account-4692848) . Log in to your account in a browser and go to**Delete Account** \> select**Request Account Delete** \>**Confirm Delete Request** \> enter the security code emailed to you and confirm deletion.
* How do I add friends on Fortnite?  
 To[ add friends on Fortnite](https://www.lifewire.com/how-to-add-friends-on-fortnite-4584407) , create a lobby and then select your**Profile icon** \>**Add Friends** . Enter a friend's Epic Games name or email, then send the request. You can also add friends outside of Fortnite using the Epic Games app.
* How do I log out of my Fortnite account?  
 To log out or switch Fornite accounts on PC, open the Epic Games launcher and select your**Profile icon** \>**Sign Out** . On game consoles, go to**Settings** \>**Account and Privacy** \>**Logout** .
