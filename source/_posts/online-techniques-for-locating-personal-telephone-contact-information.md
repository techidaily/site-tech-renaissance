...
excerpt: This Article Describes Online Techniques for Locating Personal Telephone Contact Information
...
## Online Techniques for Locating Personal Telephone Contact Information
...
![800 number for Apple Google search](https://www.lifewire.com/thmb/cML7cbxH6rTCtwzimTUOOLIPz1g=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/apple-800-number-ca05419d0a0245d8b6045d3f29edd8f3.png)
 ...
 There are quite a few toll-free number directories on the web that give extensive 1-800 number listings; however, you can also use your favorite search engine to track down nearly any toll-free phone number.
...
<!-- affiliate ads end -->
 ...
 Since every search engine returns different information from the next, it's definitely worth a try to type your person's name or phone number into various search tools, such as a[people search engine](https://www.lifewire.com/search-engines-that-top-the-web-3482269) , to see what comes back.
...
![Reverse phone number search on Spy Dialer](https://www.lifewire.com/thmb/Ua0UGlrtNxpc3-_i6vQKTEu0AxM=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/spy-dialer-phone-number-search-6d907500751c459b95fa5e058c3e2e2b.png)
 ...
 Some examples of free phone number finders that are useful whether you're trying to find someone's phone number or you're looking at who owns a particular number, include[TruePeopleSearch](https://www.truepeoplesearch.com/) , Spy Dialer, and[Whitepages](https://www.whitepages.com/phone) .

[10 Best Web Search Tricks Everyone Should Know](https://www.lifewire.com/web-search-tricks-to-know-4046148)

 FAQ

* How do I track someone's location with a phone number?  
 The easiest way is to use the native[mobile phone locator](https://www.lifewire.com/find-android-phone-lost-stolen-4691797) that comes with your Android or iOS device. Android devices use Find My Device, which is tied to your Google account, and iPhones use Find My.
* How do I block a phone number on my mobile device?  
[To block calls](https://www.lifewire.com/how-to-block-your-cell-phone-number-from-caller-id-577580) on iOS phones, tap the**i** next to the phone number then select**Block this Caller** . For Android devices, open the**Phone** app, then select the number to block. Tap**Block/report spam** or**Block Number** , depending on your device.
