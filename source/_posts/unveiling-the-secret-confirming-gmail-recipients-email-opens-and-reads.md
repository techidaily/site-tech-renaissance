---
title: "Unveiling the Secret: Confirming Gmail Recipient's Email Opens and Reads"
date: 2024-08-19T00:18:13.580Z
updated: 2024-08-20T00:18:13.580Z
categories:
  - BestProducts
description: "This Article Describes Unveiling the Secret: Confirming Gmail Recipient's Email Opens and Reads"
excerpt: "This Article Describes Unveiling the Secret: Confirming Gmail Recipient's Email Opens and Reads"
thumbnail: https://thmb.techidaily.com/e3a22512763a41f8aa30352bd2ecc133cddafc4e3c879454c4fa681286b598fc.png
---

## Unveiling the Secret: Confirming Gmail Recipient's Email Opens and Reads
### What to Know

* Open Gmail in a browser, select the box next to emails you want marked, then select**Mark as read** in the toolbar.
* Keyboard shortcut:**Settings** \>**See** **all** **settings** \>**General** \>**Keyboard** **shortcuts** **on** . Use**Shift** +**i** to mark emails read.
* Mark all mail read in a label: Open the label and select**More** (the three dots) >**Mark** **all** **as** **read** .
...
1. Find the email(s) you're interested in marking read. For example, select**Inbox** or a custom label, or[perform a search](https://www.lifewire.com/how-to-search-everything-including-the-trash-in-gmail-1172000) .
