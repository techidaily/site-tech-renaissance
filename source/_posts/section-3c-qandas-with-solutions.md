...
## Revolutionizing iPhone Charging Techniques with iOS 18 Features – Insights
...
**Also: [Every iPhone 16 model compared: Should you buy the standard, Plus, Pro, or Max?](https://www.zdnet.com/article/every-iphone-16-model-compared-should-you-buy-the-standard-plus-pro-or-max/)**

With iOS 13, Apple introduced Optimized Battery Charging, a technology that extends the lifespan of the iPhone's battery by reducing the time it is spent fully charged. The tech uses on-device machine learning to learn your daily charging routine, holding the charge at 80% and only completing the charge to 100% shortly before you typically unplug your phone.
...
With the [release of iOS 18](https://www.zdnet.com/article/ios-18-is-officially-available-for-iphone-heres-how-to-download-it-and-which-models-support-it/), the charge limit feature is only found on the iPhone 15 and [iPhone 16 handsets](https://www.zdnet.com/article/every-iphone-16-model-compared-should-you-buy-the-standard-plus-pro-or-max/); the option is not available on older iPhones.
