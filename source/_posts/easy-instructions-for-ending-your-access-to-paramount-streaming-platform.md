---
title: Easy Instructions for Ending Your Access to Paramount Streaming Platform
date: 2024-08-19T00:01:49.185Z
updated: 2024-08-20T00:01:49.185Z
categories:
  - BestProducts
description: This Article Describes Easy Instructions for Ending Your Access to Paramount Streaming Platform
excerpt: This Article Describes Easy Instructions for Ending Your Access to Paramount Streaming Platform
...
## Easy Instructions for Ending Your Access to Paramount Streaming Platform
...
* **Amazon.com** :**Your Account** \>**Subscriptions** \>**Memberships & Subscriptions** . Locate Paramount+,**Cancel subscription** .
* **iOS** **App Store:** Tap**account icon** \>**Subscriptions** \>**Active** \>**Paramount+** \>**Cancel Subscription** \>**Confirm** .

 This article explains how to cancel[ Paramount+](https://www.lifewire.com/cbs-all-access-4155838) via several sources. The easiest way to cancel is through the Paramount+ website, but this will only work if you subscribed to the service directly. If you signed up through a third-party billing provider like Amazon, Roku, the App Store, or Google Play, you’ll need to use the respective platform to complete the cancellation. 
...
1. In the App Store app, tap your**account icon** .
2. Tap**Subscriptions** .
3. Under**Active** , tap**Paramount+** .  
![Highlighted steps to cancel Paramount+ in the App Store on an iPhone.](https://www.lifewire.com/thmb/EurIvZDuavgNjz0klUcX8zIlUuA=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/C3-CancelYourParamountPlusSubscription-annotated-a584129c6c6d40d69553a6de9bb06aa9.jpeg)
4. Tap**Cancel Subscription** or**Cancel Free Trial** .
5. Tap**Confirm** to complete your cancelation.
6. You should now see a note telling you when your subscription will expire.  
<!-- affiliate ads begin -->
<a href="https://shop.mondly.com/affiliate.php?ACCOUNT=ATISTUDI&AFFILIATE=108875&PATH=https%3A%2F%2Fwww.mondly.com%3FAFFILIATE%3D108875%26RESOURCE%3D%2BBusiness%2B970x90%2B"><img src="https://secure.avangate.com/images/merchant/69c418c33ec2e1a4267fa9bb77fa1428/business-970x90.gif" border="0"></a>
<!-- affiliate ads end -->
![The Cancel Free Trial and Confirm buttons highlighted in the App Store for Paramount+.](https://www.lifewire.com/thmb/dBDnkgIAt0sfa7dV1BJYiBmyEBE=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/C6-CancelYourParamountPlusSubscription-annotated-2012390d311b4e93bc3a8e221195f180.jpeg)
...
1. Go to[ Roku's site](https://www.roku.com/) and log in to your account.
2. Click your**account icon** in the top-right corner and select**My Account** .
3. Click**Manage Subscriptions** .
4. Locate Paramount+ under**Active Subscriptions** and select**Cancel Subscription** .
5. You’ll need to select a reason for canceling. Once you do, select**Continue to Cancel** .
...
* What shows are on Paramount Plus?  
 Paramount Plus has programming from VH1, MTV, CBS, Comedy Central, Showtime, and more. Along with standards like_RuPaul's Drag Race_ ,_Yellowjackets_ , and every_Star Trek_ series, it also has originals, including_Tulsa King_ ,_Ink Master_ , and_1923_ (the prequel to_Yellowstone_ ).
* How much is Paramount Plus?  
 After the one-week free trial, you can pay for Paramount Plus monthly or annually. The Essential plan, which includes ads, is $5.99 a month/$59.99 a year. Paramount Plus also has a premium plan that's mostly commercial free and includes Showtime for $11.99 a month/$119.99 a year.
